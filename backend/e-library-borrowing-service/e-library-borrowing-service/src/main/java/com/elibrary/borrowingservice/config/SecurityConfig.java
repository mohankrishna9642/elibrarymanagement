...
public class SecurityConfig {
    ...
    @Bean
    public OncePerRequestFilter gatewayHeaderAuthFilter(AuthenticationManager authenticationManager) {
        return new OncePerRequestFilter() {
            ...
            protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
                ...
                // Modified logger.debug calls to use single Object argument (String concatenation)
